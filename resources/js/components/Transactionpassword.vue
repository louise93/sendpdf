      ...
      <div class="col-lg-4">
          <div class="ibox ">
            <div class="ibox-title">
                <h3>Forgot your current transaction password ? </h3>
                <a href="/reset/transpassword" target="_blank" class="btn btn-link text-success" >Click here</a>
            </div>
              <div class="ibox-content">
                  <div class="row">
                      <div class="col-sm-12">
                            <div class="form-group"><label>Current Transaction Password</label>
                               <input type="password" placeholder="" v-model="password"   class="form-control">

                             </div>
                             <div class="form-group"><label>New Transaction Password</label>
                                <input type="password" placeholder="" v-model="new_password"   class="form-control">

                              </div>
                              <div class="form-group"><label>Confirm Transaction Password</label>
  ...
  methods: {
      ...
      updateProfile() {
          ...
          if(this.new_password == this.confirm_password) {
            ...
            axios.post('/profile/transpasswordupdate',
                      {
