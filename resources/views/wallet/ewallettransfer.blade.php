          ...
          <div class="col-lg-4">
            ...
            @endif
              <div class="ibox-content">
                ...
                <hr>
              <form class="m-t" role="form" method="post" action="{{URL::to('wallets/ewallet/transfer')}}">
                @csrf
                  <div class="form-group">
                    <label>Amount</label>
                      <input type="number" class="form-control" min="10"  name="amount" placeholder="Amount" required="">
                  </div>
                  <div class="form-group">
