          ...
          <div class="col-lg-4">
            ...
            @endif
              <div class="ibox-content">
                <h3 > R-WALLET BALANCE : ${{ number_format(DB::table('final_r_wallet')->where('user_id',Auth::user()->user_id)->sum('amount'),2)}}</h3>
                <hr>
              <form class="m-t" role="form" method="post" action="{{URL::to('wallets/rwallet/transfer')}}">
                @csrf
