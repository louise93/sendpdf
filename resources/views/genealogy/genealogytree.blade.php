                                            ...
                                            @if($user_id == Auth::user()->user_id)
                                                        ...
                                                        <ul>
                                                          <li>
                                                            ...
                                                            @if($user1)
                                                              <a  href="{{URL::to('/genealogy/networktree/')}}/{{$user1->user_id}}" data-toggle="popover" data-trigger="hover" title="Account : {{$user1->user_id}}"  data-html="true"   data-content='<table class="table table-bordered" style="margin: 10px -10px -6px -10px;">
                                                                  <tr>
                                                          ...
                                                          <li>
                                                            @if($user8)
                                                              <a  href="{{URL::to('/genealogy/networktree/')}}/{{$user8->user_id}}" data-toggle="popover" data-trigger="hover" title="Account : {{$user8->user_id}}"  data-html="true"   data-content='<table class="table table-bordered" style="margin: 10px -10px -6px -10px;">
                                                                  <tr>
                                    ...
                                    <li>
                                      @if($user1)
                                        ...
                                        <ul >
                                             <li >
                                               @if($user2)
                                                  <a  href="{{URL::to('/genealogy/networktree/')}}/{{$user2->user_id}}" data-toggle="popover" data-trigger="hover" title="Account : {{$user2->user_id}}"  data-html="true"   data-content='<table class="table table-bordered" style="margin: 10px -10px -6px -10px;">
                                                      <tr>
                                               ...
                                               <table>
                                                ...
                                                <ul>
                                                    <li >
                                                          @if($user3)
                                                             <a  href="{{URL::to('/genealogy/networktree/')}}/{{$user3->user_id}}"  data-toggle="popover" data-trigger="hover" title="Account : {{$user3->user_id}}"  data-html="true"   data-content='<table class="table table-bordered" style="margin: 10px -10px -6px -10px;">
                                                                 <tr>
                                                    ...
                                                    <li >
                                                          @if($user4)
                                                             <a  href="{{URL::to('/genealogy/networktree/')}}/{{$user4->user_id}}" data-toggle="popover" data-trigger="hover" title="Account : {{$user4->user_id}}"  data-html="true"   data-content='<table class="table table-bordered" style="margin: 10px -10px -6px -10px;">
                                                                 <tr>
                                            ...
                                            <li>
                                                  ...
                                                  @if($user5)
                                                     <a  href="{{URL::to('/genealogy/networktree/')}}/{{$user5->user_id}}" data-toggle="popover" data-trigger="hover" title="Account : {{$user5->user_id}}"  data-html="true"   data-content='<table class="table table-bordered" style="margin: 10px -10px -6px -10px;">
                                                         <tr>
                                              ...
                                              <table>
                                                ...
                                                <ul>
                                                    <li >
                                                            @if($user6)
                                                               <a  href="{{URL::to('/genealogy/networktree/')}}/{{$user6->user_id}}" data-toggle="popover" data-trigger="hover" title="Account : {{$user6->user_id}}"  data-html="true"   data-content='<table class="table table-bordered" style="margin: 10px -10px -6px -10px;">
                                                                   <tr>
                                                    ...
                                                    <li >
                                                        @if($user7)
                                                           <a  href="{{URL::to('/genealogy/networktree/')}}/{{$user7->user_id}}" data-toggle="popover" data-trigger="hover" title="Account : {{$user7->user_id}}"  data-html="true"   data-content='<table class="table table-bordered" style="margin: 10px -10px -6px -10px;">
                                                               <tr>
                                      ...
                                      <li>
                                          ...
                                          <ul >
                                              <li >
                                                ...
                                                @if($user9)
                                                   <a  href="{{URL::to('/genealogy/networktree/')}}/{{$user9->user_id}}" data-toggle="popover" data-trigger="hover" title="Account : {{$user9->user_id}}"  data-html="true"   data-content='<table class="table table-bordered" style="margin: 10px -10px -6px -10px;">
                                                       <tr>
                                                  ...
                                                  <ul>
                                                      <li  >
                                                        @if($user10)
                                                           <a  href="{{URL::to('/genealogy/networktree/')}}/{{$user10->user_id}}" data-toggle="popover" data-trigger="hover" title="Account : {{$user10->user_id}}"  data-html="true"   data-content='<table class="table table-bordered" style="margin: 10px -10px -6px -10px;">
                                                               <tr>
                                                      ...
                                                      <li class="mb">
                                                        @if($user11)
                                                           <a  href="{{URL::to('/genealogy/networktree/')}}/{{$user11->user_id}}" data-toggle="popover" data-trigger="hover" title="Account : {{$user11->user_id}}"  data-html="true"   data-content='<table class="table table-bordered" style="margin: 10px -10px -6px -10px;">
                                                               <tr>
                                              ...
                                              <li>
                                                @if($user12)
                                                   <a  href="{{URL::to('/genealogy/networktree/')}}/{{$user12->user_id}}" data-toggle="popover" data-trigger="hover" title="Account : {{$user12->user_id}}"  data-html="true"   data-content='<table class="table table-bordered" style="margin: 10px -10px -6px -10px;">
                                                       <tr>
                                                  ...
                                                  <ul>
                                                      <li class="mb">
                                                        @if($user13)
                                                           <a  href="{{URL::to('/genealogy/networktree/')}}/{{$user13->user_id}}" data-toggle="popover" data-trigger="hover" title="Account : {{$user13->user_id}}"  data-html="true"   data-content='<table class="table table-bordered" style="margin: 10px -10px -6px -10px;">
                                                               <tr>
                                                      ...
                                                      <li class="mb">
                                                        @if($user14)
                                                           <a  href="{{URL::to('/genealogy/networktree/')}}/{{$user14->user_id}}" data-toggle="popover" data-trigger="hover" title="Account : {{$user14->user_id}}"  data-html="true"   data-content='<table class="table table-bordered" style="margin: 10px -10px -6px -10px;">
                                                               <tr>
