                    ...
                    <div class="col-lg-12">
                        <form class="m-t" role="form" method="post" action="{{URL::to('preregister/create')}}">
                          ...
                          <div class="form-group">
                              <label>Sponsor</label>
                              <input type="text" class="form-control" value="{{ Request::segment(3)}}" name="sponsor_id" readonly placeholder="ID/Username" required="">
                          </div>
                          <div class="form-group">
                            <label>Position</label>

                              <select  class="form-control" name="position" readonly>
                                  <option value="{{ Request::segment(5)}}">{{ Request::segment(5)}}</option>
