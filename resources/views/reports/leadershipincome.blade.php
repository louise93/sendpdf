  ...
  <div class="balance-card mb-15">
    <div class="d-flex align-items-center">
                  <div class="d-flex flex-grow">
                    <div class="mr-auto">
                      <h1 class="b-val"> MY Leadership Income</h1>
...
<section class="container">
  ...
  @foreach($leadershipincome as $data)
    <li>
      <div class="d-flex align-items-center justify-content-between">
                    <div class="d-flex align-items-center">
                      <!-- <img class="img-xs" src="img/content/coin1.png" alt="coin image"> -->
                      <div class="ml-10">
                        <h4 class="coin-name">Downline  :  {{ DB::table('user_registration')->where('user_id',$data->sender_id)->first(['user_id'])->user_id }} - {{ DB::table('user_registration')->where('user_id',$data->sender_id)->first(['username'])->username }}</h4>
