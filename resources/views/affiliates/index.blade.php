...
<header> <!-- extra class no-background -->
  ...
  <h1 class="page-title">SPONSOR MEMBERS</h1>
  ...
  <div class="balance-card mb-15">
    <div class="d-flex align-items-center">
                  <div class="d-flex flex-grow">
                    <div class="mr-auto">
                      <h1 class="b-val"> AFFILIATE System</h1>
        ...
        <section class="container">
        					<h4 class="title-main mt-5"> Top Earners (This Month)</h4>
        					<ul class="transaction-list list-unstyled">
                    @if(count($topearnings) > 0)
                    @foreach($topearnings as $data)
        						<li>
        							<div class="d-flex align-items-center justify-content-between">
        	                          <div class="d-flex align-items-center">
        	                            <span class="member-img"><img src="{{ asset('Nandova/img/content/avatar/user-3.png')}}" alt=""></span>
        	                            <div class="ml-10">
        	                              <h4 class="coin-name">Member ID : {{ $data->user_id }}</h4>
        	                              <small class="text-muted">Username : <span class="txt-turquoise">{{ DB::table('user_registration')
        	                          ...
        	                          <div>
                                        ...
                                        <span class="txt-turquoise">
                                           {{ number_format($data->amount,2) }} USD</span>
                                        </small>
                    ...
                    <li>
                      <div class="d-flex align-items-center justify-content-between">
                                    <div class="d-flex align-items-center">
                                      ...
                                      <div class="ml-10">
                                        <h4 class="coin-name">No Top Earner found</h4>
